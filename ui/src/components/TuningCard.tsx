...
const PARAM_FIELDS: { key: string; label: string; unit: string; default: number }[] = [
  ...
  { key: 'patient_min_dist', label: 'Patient Min', unit: 'm', default: 0.30 },
  { key: 'patient_close_dist', label: 'Patient Close', unit: 'm', default: 1.25 },
  { key: 'max_speed', label: 'Max Speed', unit: 'm/s', default: 0.325 },
  { key: 'min_speed', label: 'Min Speed', unit: 'm/s', default: 0.15 },
  { key: 'catchup_speed', label: 'Catchup Speed', unit: 'm/s', default: 0.40 },
